...
public class CurrencyController {
	...
	private final CacheManager cacheManagar;
	
	public CurrencyController(CurrencyRepository repository, CurrencyBCClient currencyBCClient, CacheManager cacheManagar) {
		super();
		this.repository = repository;
		this.currencyBCClient = currencyBCClient;
		this.cacheManagar = cacheManagar;
	}
	...
	public ResponseEntity<CurrencyEntity> getCurrency(
		...
		CurrencyEntity currency = cacheManagar.getCache(nameCache).get(keyCache, CurrencyEntity.class);
		...
		if (currency != null) {
			...
			cacheManagar.getCache(nameCache).put(keyCache, currency);
		}
